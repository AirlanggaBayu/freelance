				...
				<div class="panel panel-default">
					...
					<tbody>
						<tr>
							...
							<td><div data-toggle="modal" data-target="#ubahdata<?= $brg->id_brg?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div></td>
							<td><div data-toggle="modal" data-target="#hapus" class="btn btn-danger btn-sm"><i class="fas fa-edit"></i></div></td>
						</tr>
							<?php }?>
					</tbody>
					</table>
...
<?php 
  ...
  <div class="modal fade" id="ubahdata<?=$brg->id_brg ?>" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('dashboard/ubah_data/'.$brg->id_brg); ?>" method="post">
            ...
            aria-describedby="emailHelp" placeholder="Masukkan Username" name="nama_brg" value="<?=$brg->nama_brg?>">
            <h6>Jumlah Stok</h6>
            <input type="text" class="form-control form-control-user" id="exampleInputEmail" 
            aria-describedby="emailHelp" placeholder="Masukkan Nama Admin disini" name="stok" value="<?=$brg->stok?>">
            <h6 class="mt-2">Harga Jual</h6>
            <input type="textarea" class="form-control form-control-user" id="exampleInputEmail" 
            aria-describedby="emailHelp" placeholder="Masukkan alamat disini" name="hrg_jual" value="<?=$brg->hrg_jual ?>">
            <h6 class="mt-2">Foto</h6>
            <input type="file" class="form-control form-control-user" id="exampleInputEmail" 
            aria-describedby="emailHelp" placeholder="Masukkan Foto" name="foto_brg" value="<?=$brg->foto_brg ?>">
